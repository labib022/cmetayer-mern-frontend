...
const fallbackValues = [
  { icon: attentionIcon, header: "Attention to Detail",    description: "We clean thoroughly, focusing on the small details that make a big difference." },
  { icon: reliableIcon,  header: "Reliable Professionals", description: "Our trained cleaners arrive on time and treat every home with care." },
  { icon: safeIcon,      header: "Safe & Eco-Friendly",    description: "We use safe cleaning products that are gentle on your family and the environment." },
  { icon: customerIcon,  header: "Customer-First Service", description: "Your comfort and satisfaction are always our top priority." },
];

const iconMap = { attention: attentionIcon, reliable: reliableIcon, safe: safeIcon, customer: customerIcon };
...
export default function OurValues() {
  ...
  // values[] → { header, description, icon }
  ...
  // description field এ "Why Choose\nEASY LIFT & CLEAN" আছে
