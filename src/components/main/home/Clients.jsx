  ...
  return (
    <section className="w-full bg-white overflow-hidden py-16">
      <style>{`
        ...
        .client-person-card:hover {
          transform: rotate(6deg) translateY(-10px);
          box-shadow: 12px 8px 0 0 #ECEEF0;
        }
        ...
        .client-stat-dark:hover {
          transform: rotate(6deg) translateY(-10px);
          box-shadow: 12px 8px 0 0 #ECEEF0;
        }

        /* Stat light hover — bg + text color change */
        .client-stat-light {
          background: rgba(8, 32, 60, 0.08) !important;
          transition: transform 0.3s ease, box-shadow 0.3s ease, background 0.3s ease;
        }
        .client-stat-light:hover {
        ...
        .client-stat-light:hover .stat-light-text {
          color: #ffffff;
        }
        .stat-light-subtext {
          color: #656565;
        ...
        .client-stat-light:hover .stat-light-subtext {
