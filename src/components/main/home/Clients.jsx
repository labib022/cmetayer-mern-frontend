...
const CARDS = [
  { type: "person", img: clientImg1 },
  {
    type: "stat-dark",
    logo: "△",
    company: "Greenview Apartment",
    stat: "85+",
    label: "Move-Out Cleans Completed",
    desc: "Fast, detailed turnover cleaning for rental unit transitions.",
  },
  { type: "person", img: clientImg2 },
  {
    type: "stat-light",
    logo: "⬡",
    company: "UrbanStay Suites",
    stat: "200+",
    label: "Guest Turnovers",
    desc: "Reliable Airbnb cleaning with consistent finishing.",
  },
];
...
const hoverOn = (e) => {
  ...
  e.currentTarget.style.boxShadow = "12px 8px 0 0 #ECEEF0";
};
const hoverOff = (e) => {
