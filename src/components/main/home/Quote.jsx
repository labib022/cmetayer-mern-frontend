...
export default function GetAQuote() {
  ...
  // Left side CMS data
  const quoteData   = data?.data?.home?.["Quote"]?.[0];
  const heading     = quoteData?.title       || "Looking for Professional Home Management Services?";
  const description = quoteData?.description || "Request a free quote today and let our team create a cleaning plan tailored to your home or property needs.";
  const subText     = quoteData?.sub_text    || "Tell us a bit about your home, and we'll guide you to the right cleaning solution.";
    ...
    <section className="w-full max-w-360 mx-auto px-4 sm:px-8 md:px-12 lg:px-16 py-12 sm:py-16 md:py-20 bg-white">
      <div className="flex flex-col lg:flex-row items-start gap-10 lg:gap-16 xl:gap-24">
        ...
        <div className="flex flex-col items-start gap-6 flex-1">
          ...
          <h2
            style={{ fontFamily: '"Rethink Sans", sans-serif', letterSpacing: "-1.248px" }}
        ...
        <div className="relative w-full lg:w-160 shrink-0">
          ...
          >
            ...
            {/* Error message */}
            {error && (
              <p style={{ fontFamily: '"Rethink Sans", sans-serif' }} className="text-red-500 text-sm m-0">
                {error}
              </p>
            )}
