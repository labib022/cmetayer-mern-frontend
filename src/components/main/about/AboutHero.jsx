...
export default function AboutHero() {
  ...
  const topAbout = data?.data?.about_us?.top_about?.[0] || {};
  const title = topAbout.title || "The Easy Lift & Clean Standard";
  const description = topAbout.description || "Easy Lift & Clean was founded to revolutionize how you manage your home. We provide a single, trusted point of contact for moving, repair, laundry, and cleaning services.";
