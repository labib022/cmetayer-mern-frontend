...
export default function CleaningSuccess({ data }) {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#F0F0F0] px-4 py-10">
      <div
        className="w-full max-w-120 flex flex-col items-center gap-8 text-center"
        style={{
          padding: "32px",
          borderRadius: "32px",
          background: "#FAFAFA",
      ...
      >
        ...
        <div
          ...
          style={{ width: "64px", height: "64px", backgroundColor: "#E8F5F0" }}
        >
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            Your cleaning appointment has been scheduled. Our team
            will arrive at the requested time.
          </p>
        </div>
        ...
        >
          <p
            className="font-rethink font-semibold leading-[140%] m-0"
