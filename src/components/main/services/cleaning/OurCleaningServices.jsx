...
const fallbackImgs = [img1, img3, img4];
...
const fallbackServices = [
  ...
  {
    header: "Handyman & Repair",
    sub_header: "Plumbing, electrical, assembly, and general professional home repairs.",
    image: img3,
  },
  {
...
export default function OurServices() {
  const { data, isLoading } = useGetServicePageQuery("cleaning");

  const serviceSection = data?.data?.cleaning?.["Our Services"]?.[0];
