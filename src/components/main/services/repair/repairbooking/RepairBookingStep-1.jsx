...
import { useSubmitRepairQuoteMutation } from "../../../../../redux/features/cms/cmsApi";
...
export default function RepairBookingStep1({ data, setData }) {
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                value={data.fullName} onChange={handleChange("fullName")} required
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                value={data.email} onChange={handleChange("email")} required
                className={inputClass} style={{ borderRadius: "8px", border: "0.5px solid #E8EDE4" }}
                onFocus={(e) => (e.target.style.borderColor = "#08203C")}
                onBlur={(e) => (e.target.style.borderColor = "#E8EDE4")}
              />
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                value={data.phone} onChange={handleChange("phone")} required
                className={inputClass} style={{ borderRadius: "8px", border: "0.5px solid #E8EDE4" }}
                onFocus={(e) => (e.target.style.borderColor = "#08203C")}
                onBlur={(e) => (e.target.style.borderColor = "#E8EDE4")}
              />
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <select
                  value={data.serviceCategory} onChange={handleChange("serviceCategory")}
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                style={{ borderRadius: "8px", border: "0.5px solid #E8EDE4", resize: "vertical" }}
                onFocus={(e) => (e.target.style.borderColor = "#08203C")}
                onBlur={(e) => (e.target.style.borderColor = "#E8EDE4")}
              />
            </div>
              ...
              >
                {data.photoPreview ? (
                  ...
                  <>
                    ...
                    <p className="font-rethink font-medium text-center m-0" style={{ color: "#08203C", fontSize: "14px", lineHeight: "20px" }}>Click to upload</p>
                    <p className="font-rethink font-normal text-center m-0" style={{ color: "#656565", fontSize: "12px", lineHeight: "16px" }}>PNG, JPG up to 5MB</p>
                  </>
                )}
