...
import { useGetLaundryPriceMutation } from "../../../../../redux/features/cms/cmsApi";
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#F0F0F0] px-4 py-10">
      ...
      >
        ...
        {/* Title */}
        <h1 className="font-rethink font-medium leading-[130%] tracking-[-1.248px] m-0"
        ...
        <div className="flex flex-col lg:flex-row gap-6 w-full">
          ...
          <div className="flex flex-col gap-5 flex-1"
            ...
            <h2 className="font-rethink font-medium leading-[140%] tracking-[-0.936px] m-0"
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <select value={data.bagSize || BAG_SIZES[1].label}
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <select value={data.washType || WASH_TYPES[0].label}
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <select value={data.detergent || DETERGENTS[0]}
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <input type="datetime-local" value={data.serviceDate || ""}
          ...
          <div className="flex flex-col gap-4 w-full lg:w-60 shrink-0"
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-rethink font-bold tracking-[-1.248px]"
        ...
        <div className="flex items-center gap-4 w-full">
          ...
          <Link to="/services/laundry/laundry-booking/laundry-contact-info"
            ...
            <span className="flex items-center justify-center w-10 h-10 rounded-full text-white text-base shrink-0"
