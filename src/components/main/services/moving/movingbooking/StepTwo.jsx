...
export default function StepTwo({ data, setData }) {
  ...
  const removeHeavyItem = (item) => {
    setData({ ...data, heavyItems: data.heavyItems.filter((i) => i !== item) });
  };
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="w-full h-1.5 rounded-full bg-[#E3E8EF] overflow-hidden">
            <div
              ...
              style={{ width: "66.66%", backgroundColor: "#08203C" }}
            />
          </div>
        </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-wrap gap-2 min-h-10">
              {data.heavyItems?.map((item) => (
                <span
                  key={item}
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-rethink font-medium text-white"
                ...
                >
                  ...
                  <button
                    ...
                    className="bg-transparent border-none text-white cursor-pointer text-xs leading-none hover:opacity-70"
                  >
                    ✕
                  </button>
                </span>
