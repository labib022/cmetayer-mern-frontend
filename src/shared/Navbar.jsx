...
export default function Navbar() {
  ...
  return (
    <div className="w-full sticky top-0 py-6 z-50 bg-[#08203C]">
      <div className="max-w-368 mx-auto px-4 md:px-8">
          ...
          <div className="md:hidden mt-2 rounded-2xl px-4 py-4 bg-[#08203C] border border-white/10">
            <div className="flex flex-col gap-1">
              ...
              <a
                href="/contact"
                onClick={() => setMobileMenuOpen(false)}
                className="font-rethink w-full flex items-center justify-center rounded-2xl bg-white hover:opacity-90 transition-opacity mt-3 py-2.5 text-[#08203C] text-sm font-semibold no-underline"
              >
                Contact Us →
              </a>
            </div>
