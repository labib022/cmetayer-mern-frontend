...
export default function Footer() {
  ...
  const location  = system?.location  || "120 King Street West, Suite 1400, Toronto, Ontario, Canada";
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-10 lg:gap-8 px-0 sm:px-4 lg:px-6">
            ...
            <div className="flex flex-col gap-6">
              <div className="relative flex items-center gap-3">
                <h3 className="text-white text-xl sm:text-2xl font-semibold leading-[140%]"
                  style={{ fontFamily: '"Rethink Sans", sans-serif' }}>
                  Stay Updated with
                </h3>
                <Link to="/" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
                  <img src={logo} alt="Logo" className="w-34 md:w-55 object-contain cursor-pointer" />
                </Link>
              </div>

              <p className="text-[#E0E0E0] text-base font-bold leading-[140%] m-0"
                style={{ fontFamily: '"Rethink Sans", sans-serif' }}>
            ...
            <div className="flex gap-12 sm:gap-16 lg:gap-20">
              <div className="flex flex-col gap-6 w-42">
                <h4 className="text-white text-base font-semibold leading-[140%] m-0"
                  style={{ fontFamily: '"Rethink Sans", sans-serif' }}>
                  Quick Links
                </h4>
        ...
        <div className="p-2">
          <div className="w-full bg-white rounded-2xl p-8 sm:p-10 lg:p-12 flex flex-col sm:flex-row flex-wrap gap-10 sm:gap-12">
            ...
            <div className="flex flex-col gap-2 flex-1 min-w-45">
              <p className="text-[#444] text-base font-bold leading-[140%] m-0"
                style={{ fontFamily: '"Rethink Sans", sans-serif' }}>
                Our Location
              </p>
              <p className="text-[#111] text-lg sm:text-xl font-medium leading-[140%] m-0"
          ...
          {/* Copyright */}
          <p className="text-center text-white/50 text-xs py-4 m-0"
            style={{ fontFamily: '"Rethink Sans", sans-serif' }}>
            {copyright}
          </p>
        </div>
